...
import com.mindScriptAct.pureTest.controller.testing.PureInject1Command;
import com.mindScriptAct.pureTest.controller.testing.PureInject2Command;
import com.mindScriptAct.pureTest.controller.testing.PureInject4Command;
import com.mindScriptAct.pureTest.controller.testing.PureInject8Command;
 ...
 */
public class CommandPureTestFacade extends Facade implements IFacade {
	...
	public function startUp(mainObj:PureTest):void {
		...
		registerCommand(Note.CALL_COMMANDS_1, PureInject1Command);
		registerCommand(Note.CALL_COMMANDS_2, PureInject2Command);
		registerCommand(Note.CALL_COMMANDS_4, PureInject4Command);
		registerCommand(Note.CALL_COMMANDS_8, PureInject8Command);
	...
	private function prepareTests():void {
		...
		performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_EMPTY], TestNames.COMMAND_EMPTY, 100, 1000);
		performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_1], TestNames.COMMAND_INJECT_1, 100, 1000);
		performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_2], TestNames.COMMAND_INJECT_2, 100, 1000);
		performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_4], TestNames.COMMAND_INJECT_4, 100, 1000);
		performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_8], TestNames.COMMAND_INJECT_8, 100, 1000);
		
		//performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_EMPTY], TestNames.COMMAND_EMPTY, 100, 10000);
		//performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_GET_PARAMS, "testData"], TestNames.COMMAND_PARAMS, 100, 10000);
		//performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_WITH_MODEL], TestNames.COMMAND_MODEL, 100, 10000);
		//performanceTest.queueSimpleTest(sendNotification, [Note.CALL_COMMANDS_WITH_MODEL_COMM_VIEWS], TestNames.COMMAND_MODEL_AND_VIEW, 100, 10000);
		//
		...
		//
		//performanceTest.queueSimpleTest(sendNotification, [Note.MEDIATOR_COMM_TEST], TestNames.MEDIATOR_COMMUNICATE_1, 100, 20000);
		//
		//performanceTest.queueTestSuite(new TestSuite([new MethodTest(sendNotification, [Note.MEDIATOR_COMM_TEST, 1], TestNames.MEDIATOR_COMMUNICATE_100, 50, 2000)], "Communication test 100", null, spawn100Mediators));
